...
let routes = [
    ...
    //{ path: '/main', component: Main },
    {
        ...
        children: [
            ...
            { path: '/suyuanUser',component: resolve => require(['./views/desktop/SuyuanUser.vue'], resolve), name: '溯源用户管理' },
            { path: '/suyuanCard',component: resolve => require(['./views/desktop/SuyuanCard.vue'], resolve), name: '溯源码管理' },
            { path: '/suyuanClasses',component: resolve => require(['./views/desktop/SuyuanClasses.vue'], resolve), name: '溯源分类管理' },
            { path: '/suyuanWeight',component: resolve => require(['./views/desktop/SuyuanWeight.vue'], resolve), name: '溯源单位管理' },
            ...
            { path: '/classes',component: resolve => require(['./views/desktop/Classes.vue'], resolve), name: '分类管理' },
