<template> 
 <div class="block">   
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="name" label="用户名" width="140" sortable>
                
			</el-table-column>
			<el-table-column prop="code" label="身份证号码" width="200" sortable>
			</el-table-column>

            <el-table-column prop="phone" label="手机号" width="180" sortable>
			</el-table-column>

               <el-table-column prop="cardNo" label="溯源码" width="180" sortable>
			</el-table-column>
              <el-table-column prop="type" label="类型" width="120" sortable>
			</el-table-column>
             <el-table-column prop="weight" label="重量" width="120" sortable>
			</el-table-column>
			...
			<el-form ref="subData" :model="subData" label-width="100px" @submit.prevent="onSubmit" style="margin:20px;"  id="formid" action=""  method="post" enctype="multipart/form-data" target="frameName">
                    ...
                    <el-form-item label="手机号">
                     ...
                     <el-form-item label="溯源码">
                        <el-input name="cardNo"  v-model="subData.cardNo"  placeholder="请输入溯源码"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="养殖区域">
                        <el-input name="address"  v-model="subData.address"  placeholder="请输入养殖区域"></el-input>
                    </el-form-item>
                    <el-form-item label="类型">
                     
                        <el-select  v-model="subData.type" placeholder="请选择类型">
                             <el-option
                     ...
                     <el-form-item label="重量">
                        ...
                        <el-select  v-model="subData.weight" placeholder="请选择重量">
                             <el-option
...
<script>
    ...
    handleRemove(file, fileList) {
      ...
      updateRow1(rows){
       ...
       this.$confirm('确认删除, 是否继续?', '提示', {
            ...
            //删除功能暂时不开放
            RequestPost("/suyuanCard/delete",rows).then(response => {
      ...
      update(index, rows) {
        ...
        RequestGet("/suyuanClasses/findAllSelect",{}).then(response => {
                if(response.code == '0000'){
        ...
        RequestGet("/suyuanWeight/findAllSelect",{}).then(response => {
                if(response.code == '0000'){
      ...
      open(){
        ...
        //this.validate();
             ...
             //删除功能暂时不开放
            RequestPost("/suyuanCard/update",this.subData).then(response => {
	...
	loadData(){
       ...
       // this.page.state = '10';
		...
		RequestGet("/suyuanCard/findAll",this.page).then(response => {
						if(response.code == '0000'){
